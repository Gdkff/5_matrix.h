...
START_TEST(sub_matrix_test_1) {
  ...
  R2.matrix[0][0] = -1;
  int err_R = s21_sub_matrix(&A, &B, &R);
...
START_TEST(sub_matrix_test_6) {
  ...
  int err_R = s21_sub_matrix(&A, &B, NULL);
...
START_TEST(sub_matrix_test_7) {
  ...
  int err_R = s21_sub_matrix(&A, NULL, NULL);
...
START_TEST(sub_matrix_test_8) {
  int err_R = s21_sub_matrix(NULL, NULL, NULL);
...
Suite *suite_s21_sub_matrix(void) {
  ...
  tcase_add_test(tc, sub_matrix_test_10);
  tcase_add_test(tc, sub_matrix_test_11);
